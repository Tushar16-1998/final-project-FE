...
const vehiclesData = [
    ...
    { id: 8, type: 'Boat', brand: 'Bayliner', model: 'Element E16', year: 2022, price: 250, imageUrl: 'https://images.boattrader.com/resize/1/73/49/8557349_20230511074656691_1_XLARGE.jpg' },
];
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                {filteredVehicles.map(vehicle => (
                    <div key={vehicle.id} className="border border-gray-300 rounded-md p-6 transition-all duration-300 transform hover:shadow-lg hover:-translate-y-1 hover:border-blue-500">
                        ...
                        <Link to="/reqform" className="btn btn-outline btn-sm mt-4">Select</Link>
                        <Link to="/listform" className="btn btn-outline btn-sm mt-4">Update</Link>
                    </div>
                ))}
            </div>
